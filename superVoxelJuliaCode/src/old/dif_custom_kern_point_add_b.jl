...
# function point_info_kern_deff_add_b(tetr_dat, d_tetr_dat, out_sampled_points, d_out_sampled_points, source_arr, d_source_arr, control_points, d_control_points, sv_centers, d_sv_centers, num_base_samp_points, num_additional_samp_points
# )
#     # shared_arr = CuStaticSharedArray(Float32, (128,3))
#     # d_shared_arr = CuStaticSharedArray(Float32, (128,3))
#     Enzyme.autodiff_deferred(Enzyme.Reverse, Enzyme.Const(point_info_kern_add_b), Const
...
# function call_point_info_kern_add_b(tetr_dat, out_sampled_points, source_arr, control_points, sv_centers, num_base_samp_points, num_additional_samp_points, threads, blocks, pad_point_info)
...
#     @cuda threads = threads blocks = blocks point_info_kern_add_b(tetr_dat, out_sampled_points, source_arr, control_points, sv_centers, num_base_samp_points, num_additional_samp_points)
...
# function ChainRulesCore.rrule(::typeof(call_point_info_kern_add_b), tetr_dat, out_sampled_points, source_arr, control_points, sv_centers, num_base_samp_points, num_additional_samp_points, threads_point_info, blocks_point_info, pad_point_info)


#     out_sampled_points = call_point_info_kern_add_b(tetr_dat, out_sampled_points, source_arr, control_points, sv_centers, num_base_samp_points, num_additional_samp_points, threads_point_info, blocks_point_info, pad_point_info)   
...
#         @device_code_warntype @cuda threads = threads_point_info blocks = blocks_point_info point_info_kern_deff_add_b(tetr_dat, d_tetr_dat, out_sampled_points, d_out_sampled_points, source_arr, d_source_arr, control_points, d_control_points, sv_centers, d_sv_centers, num_base_samp_points, num_additional_samp_points
#         )
#         #reverse padding
